...
// https://haristark.ccbp.tech/
// https://harimern.ccbp.tech/
...
class AppStore extends Component {
  ...
  render() {
    ...
    let filteredApps = this.getTabFilteredApps()
          ...
          <ul className="tabs-lists-container">
            {tabsList.map(eachObj => (
              <TabItem
                ...
                isActive={activeTabId === eachObj.tabId}
              />
            ))}
          </ul>

          <ul className="apps-list-container">
            {filteredApps.map(eachObj => (
              <AppItem key={eachObj.appId} eachObj={eachObj} />
            ))}
          </ul>
        </div>
      </div>
